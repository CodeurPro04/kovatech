  ...
  return (
    <>
      <section className="page-title text-center">
        ...
        <figure className="image" style={{ marginTop: "55px" }}><img src="assets/images/resource/page-title.png" alt="" /></figure>
        <div className="clients-box" style={{ marginTop: "55px" }}>
          ...
          <h3>Plus de <span className="gradient-color">40.00+</span> avis excellents</h3>
        </div>
